...
use crate::history::history_system::{HistoryError, ValidatedHistoryEvent};
...
pub(crate) struct RecruitmentPlan {
    pub(super) draft: RecruitmentDraft,
    pub(super) context: RecruitmentPlanContext,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(super) struct RecruitmentPlanContext {
    pub(super) previous_organization: Option<OrganizationId>,
    previous_supervisor: Option<CharacterId>,
    pub(super) occurred_at: SimTime,
    factors: RecruitmentFactors,
    margin: i16,
    pub(super) outcome: RecruitmentOutcome,
