...
- **Operating posture** — matched keep-open and suspended home-racket branches begin from identical seeded authoritative state. Over the same two-day window, suspension stops racket settlements while legitimate front trade and wages continue. Canonical resumption schedules a full new cycle with no backlog payout. The readout and `posture-w<world>-p<policy>.json` retain actual earnings and payroll, not a claim that suspension clears investigations; this clean-fixture comparison measures the income cost, not a law-enforcement benefit.
...
- **Manager reports reach leadership** — notable enterprise settlements atomically persist a Financial report citing the manager's organization-held information, so executive briefs surface the same observed economics, changed street surcharge, vice warning, and loss suspension without revealing formal case internals. Unchanged profitable, low-variance heat settles as routine without another report. Focused regressions cover brief inclusion without pending decisions, unchanged-heat silence, and report-ID exhaustion rejecting the entire settlement without mutation. Narration quotes only this organization's cycles; live rival racket totals remain diagnostic-only.
