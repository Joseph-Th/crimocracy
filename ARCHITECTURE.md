...
```text
 1  content::build_registry          validated immutable registry (CURRENT_CONTENT_REVISION = 37)
 ...
 7  build_save / restore_save         envelope {format:1, content_revision:37, state:66}
```
...
| `content/` | Code-owned authored definitions for the registry | `build_registry` | `src/content/mod.rs` (`CURRENT_CONTENT_REVISION=37`) |
