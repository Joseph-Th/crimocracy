...
fn record_empty_report(state: &mut AppState, recipient: OrganizationId, title: &str) -> ReportId {
...
fn restore_rejects_report_citing_decision_requested_later() {
    ...
    validate_set_relationship(
        ...
        RelationshipDimensions {
            ...
            affection: level,
            dependence: RelationshipLevel::try_new(0).expect("zero relationship level is valid"),
            resentment: RelationshipLevel::try_new(0).expect("zero relationship level is valid"),
