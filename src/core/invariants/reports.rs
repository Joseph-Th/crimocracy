//! Release-safe structural and registry-relative validation for persisted reports.
...
pub(super) fn validate_reports(state: &AppState) -> Result<(), StateValidationError> {
