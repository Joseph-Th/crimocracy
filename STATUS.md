...
| Legitimate economy | Business operating economies with ownership transfer/history, scheduled cycles, authored economics including the per-kind acquisition price, accounting information, comparative reporting, sabotage/arson disruption horizons with degraded earning power, chronic-loss suspension counted since the latest resumption; organizations buy independently owned businesses outright at that price in accounted funds, capitalizing acquired books, opening the first operating economy when none exists, reopening suspended books; acquisitions surface as Notable financial reports for the buyer | `src/economy/` via `business_economy_system`, `business_acquisition`, and reporting modules |
