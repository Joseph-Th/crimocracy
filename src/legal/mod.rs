...
pub use records::{
    ...
    InformantDraft, InformantRecord, InvestigationDraft, InvestigationRecord, InvestigationStatus,
    ...
    InvestigationWorkStatus, JurisdictionDraft, JurisdictionRecord, LegalRepresentationDraft,
